...
const addPremiumCmd = async (m, sock) => {
  ...
  const allowedAdmins = ['233538733413']; // <-- your master admin list here
    ...
    return sock.sendMessage(m.from, {
      ...
      contextInfo: {
        ...
        externalAdReply: {
          ...
          mediaUrl: 'https://github.com/Bryanlover1',
          sourceUrl: 'https://github.com/Bryanlover1',
  ...
  try {
    ...
    await sock.sendMessage(m.from, {
      ...
      contextInfo: {
        ...
        isForwarded: true,
        externalAdReply: {
          title: 'KHAOS XMD PREMIUM MODE',
          body: '🔰 Access granted successfully!',
          mediaUrl: 'https://github.com/Bryanlover1',
          sourceUrl: 'https://github.com/Bryanlover1',
          thumbnailUrl: 'https://i.imgur.com/Axre4u3.jpeg',
          mediaType: 1,
          showAdAttribution: true,
        }
      }
